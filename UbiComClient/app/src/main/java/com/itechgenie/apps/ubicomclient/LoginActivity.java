...
public class LoginActivity extends AppCompatActivity implements
        ...
        View.OnClickListener, ITGConstants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Buttons
        viewServicesButton = (Button) findViewById(R.id.view_services_button);

        // Button listeners
        findViewById(R.id.sign_in_button).setOnClickListener(this);
        findViewById(R.id.sign_out_button).setOnClickListener(this);
        findViewById(R.id.disconnect_button).setOnClickListener(this);
        findViewById(R.id.view_services_button).setOnClickListener(this);
    ...
    private void updateUI(boolean signedIn) {
        ...
        if (signedIn) {
            ...
            viewServicesButton.setVisibility(View.VISIBLE);
            viewServicesButton.setText(R.string.view_rooms);
        } else {
            viewServicesButton.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.disconnect_button:
                revokeAccess();
                break;
            case R.id.view_services_button:
                viewServices();
                break;
        }
    }
